      ...
      <div className="px-4 md:px-8 lg:px-10 xl:px-12 pt-24 pb-12 w-full relative z-10 flex flex-col lg:flex-row lg:items-center lg:gap-16">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <ScrollReveal delay={200}>
            <p className="text-[18px] font-normal text-black/60 leading-[1.5] max-w-[460px] mt-10 mx-auto lg:mx-0">
          ...
          <ScrollReveal delay={300}>
            <div className="flex items-center justify-center lg:justify-start gap-4 mt-8">
              <button onClick={showWaitlist} className="text-[15px] font-medium text-black px-8 py-4 rounded-lg bg-[#A5F41F] hover:bg-black hover:text-white transition-colors inline-flex items-center gap-2 cursor-pointer">Tapp Me In <span className="text-[16px]">&#x2197;</span></button>
