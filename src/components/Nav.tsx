      ...
      >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`text-[13px] font-semibold px-5 py-2.5 rounded-full transition-colors cursor-pointer ${scrolled ? 'bg-[#A5F41F] text-black hover:bg-[#94DC1B]' : 'bg-[#A5F41F] text-black hover:bg-[#94DC1B] lg:bg-black lg:text-white lg:hover:bg-black/80'}`}
          >
            Join Waitlist
          </button>
